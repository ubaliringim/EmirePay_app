export const NETWORK_PROVIDERS = [
  { id: 'mtn', name: 'MTN', color: '#FFCC00', logo: require('../assets/mtn.jpg') },
  { id: 'airtel', name: 'Airtel', color: '#ED1C24', logo: require('../assets/airtel.jpg') },
  { id: 'glo', name: 'Glo', color: '#00AA00', logo: require('../assets/glo.jpg') },
